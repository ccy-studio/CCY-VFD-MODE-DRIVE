...
<el-card class="box-card"><el-form ref="form" :model="form" label-width="100px" label-position="top"><el-form-item label="滚动文字"><span slot="label">滚动文字<el-tag effect="plain" style="margin-left: 5px;" size="mini" type="info">英文数字,英文下的标点符号。不支持中文</el-tag></span>
